...
# ble-bind -f 'S-RET'     'newline'
# ble-bind -f 'S-RET'     'accept-single-line-or-newline'
# ble-bind -f 'C-RET'     'auto_complete/insert'
# ble-bind -f 'M-RET'     'auto_complete/accept-line'
# ble-bind -f 'M-C-RET'   'auto_complete/accept-line'
# ble-bind -f 'ESC'       'auto_complete/cancel'
# ble-bind -f 'right'     'auto_complete/insert-on-end'
# ble-bind -f 'M-right'   'auto_complete/insert-word'


# ble-bind -f 'ESC'       'dabbrev/cancel'
# ble-bind -f 'C-r'       'dabbrev/next'
# ble-bind -f 'C-s'       'dabbrev/prev'
# ble-bind -f 'ESC'       'dabbrev/exit'
# ble-bind -f 'RET'       'dabbrev/accept-line'
# ble-bind -f 'RET'       'menu/accept'
# ble-bind -f 'ESC'       'menu/cancel'
...
# ble-bind -f 'M-h'       'history-expand-line'
# ble-bind -f 'M-l'       'shell-expand-line'
# ble-bind -f 'M-t'       'tilde-expand'
# ble-bind -f 'f1'        'command-help'
# ble-bind -f 'S-M-left'  '@nomarked non-space-beginning-of-line'
...
function blerc/vim-load-hook {
  ...
  #ble-bind -m vi_nmap 'g g' vi-command/first-nol
  #ble-bind -m vi_omap 'g g' vi-command/first-nol
  #ble-bind -m vi_xmap 'g g' vi-command/first-nol
  #ble-bind -m vi_nmap 'G' vi-command/last-line
  #ble-bind -m vi_omap 'G' vi-command/last-line
  #ble-bind -m vi_xmap 'G' vi-command/last-line
